...
.then().log().all()
	...
	public void addUserWithRecordTest() {
		...
		UserRecord user = new UserRecord("John Doe", "johnwe@example.com", "male", "active");
...
.then().log().all()
	...
	public static void main(String a[]) {
		...
		try (BufferedReader reader = new BufferedReader(new FileReader("./src/test/java/CreateUserWithPOJOAndLombok/file.txt"))) {
		    String line;
